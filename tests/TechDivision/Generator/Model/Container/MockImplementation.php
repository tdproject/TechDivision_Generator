 ...
 * @license GPL
 */
class TechDivision_Generator_Model_Container_MockImplementation
    extends TechDivision_Lang_Object
    implements TechDivision_Model_Interfaces_Container {

	/**
	 * Holds the name of the application that initializes the manager
	 * @var string
	 */
	protected $_applicationName = "unknown";
	 ...
	 * 		Holds the name of the application that initializes the container
    ...
    protected function __construct(
		...
		// set the application name  and the session id
	...
	public static function getContainer(
	    ...
	    $sessionId = null,
	    TechDivision_Model_Configuration_Interfaces_Container $containerConfiguration = null) {
		return new TechDivision_Generator_Model_Container_MockImplementation(
		    $applicationName,
		    $sessionId,
    ...
    /**
     * This method returns the name of the application that initializes
     * the container.
     *
     * @return string Holds the application name
     * @see TechDivision_Model_Interfaces_Container::getApplicationName()
     */
