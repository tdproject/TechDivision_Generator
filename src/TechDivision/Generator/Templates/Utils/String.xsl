...
<xsl:stylesheet version="1.0"
  ...
  <doc:reference xmlns="">
	...
	$Id: string.xsl,v 1.1 2007-10-25 16:09:14 wagnert Exp $
      </releaseinfo>
      <author>
  ...
  <doc:template name="str:decapitalise" xmlns="">
    <refpurpose>Decapitalise string</refpurpose>

    <refdescription>
      <para>Converts first character of string to an lowercase letter</para>
    </refdescription>
	...
	<varlistentry>
	  <term>text</term>
	  <listitem>
	    <para>The string to be decapitalised</para>
	  </listitem>
	</varlistentry>
	<varlistentry>
	  <term>all</term>
	  <listitem>
	    <para>Boolean controlling whether all words in the string are decapitalised.</para>
	    <para>Default is true.</para>
	  </listitem>
	</varlistentry>
      </variablelist>
    ...
    <refreturn>
      <para>Returns string with first character lowcase and all remaining characters uppercase.</para>
    </refreturn>
  </doc:template>

  <xsl:template name="str:decapitalise">
    <xsl:param name="text"/>
    <xsl:param name="all" select="true()"/>
	...
	<xsl:call-template name="str:decapitalise">
	  <xsl:with-param name="text">
	    <xsl:value-of select="$firstword"/>
	  </xsl:with-param>
	  <xsl:with-param name="all" select="false()"/>
